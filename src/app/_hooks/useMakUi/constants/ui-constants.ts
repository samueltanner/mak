...
export const tailwindToCssModifierObject: {
  ...
  "peer-hover": "&:has(~ .peer:hover)",
  "peer-focus": "&:has(~ .peer:focus)",
  "peer-focus-within": "&:has(~ .peer:focus-within)",
  "peer-focus-visible": "&:has(~ .peer:focus-visible)",
  "peer-active": "&:has(~ .peer:active)",
  "peer-visited": "&:has(~ .peer:visited)",
  "peer-target": "&:has(~ .peer:target)",
  ...
  "peer-is-has-not": (selector: string, altSelector: string) =>
    `:is(${selector}):not(:has(~ ${altSelector}))`,
  "peer-first": "&:has(~ .peer:first-child)",
  "peer-last": "&:has(~ .peer:last-child)",
  "peer-only": "&:has(~ .peer:only-child)",
  "peer-odd": "&:has(~ .peer:nth-child(odd))",
  "peer-even": "&:has(~ .peer:nth-child(even))",
  "peer-first-of-type": "&:has(~ .peer:first-of-type)",
  "peer-last-of-type": "&:has(~ .peer:last-of-type)",
  "peer-only-of-type": "&:has(~ .peer:only-of-type)",
  ...
  "peer-valid": "&:has(~ .peer:valid)",
  "peer-invalid": "&:has(~ .peer:invalid)",
  "peer-in-range": "&:has(~ .peer:in-range)",
  "peer-out-of-range": "&:has(~ .peer:out-of-range)",
  "peer-placeholder-shown": "&:has(~ .peer:placeholder-shown)",
  "peer-autofill": "&:has(~ .peer:autofill)",
  "peer-read-only": "&:has(~ .peer:read-only)",
  "peer-fullscreen": "&:has(~ .peer:fullscreen)",
  "peer-last-child": "&:has(~ .peer:last-child)",
  "peer-link": "&:has(~ .peer link)",
  "peer-not-checked": "&:not(:has(~ .peer:checked))",
  "peer-only-child": "&:has(~ .peer:only-child) ",
  "peer-optional": "&:has(~ .peer:optional) ",
  "peer-read-write": "&:has(~ .peer:read-write) ",
  "peer-first-child": "&:has(~ .peer:first-child) ",
}
