...
const palette: MakUiFlexiblePaletteInput = {
  primary: "dark:mak-teal-500 light:mak-teal-300",
  secondary: "dark:sky-800 light:sky-400",
  tertiary: "dark:fuchsia-800 light:fuchsia-400",
  custom: "dark:zinc-600 light:zinc-400",
  success: "dark:emerald-600 light:emerald-400",
  error: "dark:red-600 light:red-400",
  danger: "dark:red-600 light:red-400",
  warning: "dark:yellow-600 light:yellow-400",
  info: "dark:blue-600 light:blue-400",
